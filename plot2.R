## This script uses the data from the dates 2007-02-01 and 2007-02-02 in "Electric power consumption" (https://d396qusza40orc.cloudfront.net/exdata%2Fdata%2Fhousehold_power_consumption.zip) to plot line for global active power by minute to png file.
...
## Plot line for global active power by minute to png file

png(filename = "plot2.png",width = 480, height = 480)
plot(extractDataPlot$Datetime,extractDataPlot$Global_active_power,type = "l",ylab = "Global Active Power (kilowatts)", xlab = "")
dev.off()
