## This script uses the data from the dates 2007-02-01 and 2007-02-02 in "Electric power consumption" (https://d396qusza40orc.cloudfront.net/exdata%2Fdata%2Fhousehold_power_consumption.zip) to plot line for energy of each of the 3 sub-meters by minute to png file.
...
## Plot line for each of the 3 sub-meters by minute to png file
